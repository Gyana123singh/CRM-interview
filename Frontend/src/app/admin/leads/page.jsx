...
export default function LeadsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (lead) => (
        <span
          className={`px-2.5 py-0.5 rounded text-xs font-bold border whitespace-nowrap inline-block shrink-0 ${lead.source === "Website"
    ...
    <DashboardWrapper>
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-800/80 pb-5">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-400 max-w-2xl">
              Ingest website, referral, social media, email, and phone leads. Assign reps, track timeline, edit priority, and execute lead conversion.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5 shrink-0">
            <button
              ...
              title="Generate Ingestion Scripts for Website, Referral, Social, Email, Phone"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 h-10 px-3.5 border border-indigo-500/30 bg-indigo-500/10 rounded-xl text-xs font-semibold text-indigo-300 hover:bg-indigo-500/20 transition-all whitespace-nowrap shrink-0"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 h-10 px-3.5 border border-slate-800 bg-slate-900/80 hover:bg-slate-800 rounded-xl text-xs font-semibold text-slate-300 transition-all whitespace-nowrap shrink-0"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 h-10 px-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-semibold shadow-lg shadow-indigo-600/20 transition-all whitespace-nowrap shrink-0"
            >
        ...
        <div className="flex flex-wrap items-center gap-4 p-4 bg-slate-900/60 border border-slate-800 rounded-xl backdrop-blur-md">
          ...
          <div className="flex items-center gap-2 text-xs">
            <span className="font-semibold text-slate-400">Channel Source:</span>
            <select
              value={sourceFilter}
              onChange={(e) => {
        ...
        <DataTable
          ...
          searchPlaceholder="Search leads by name, email, phone, service interest..."
          emptyMessage="No leads found matching your search criteria."
        />
        ...
        {/* Ingestion Script Generator & Embed Builder Modal */}
            ...
            <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl text-slate-100">
              ...
              <form onSubmit={handleAddLeadSubmit} className="mt-4 space-y-4 text-xs">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-slate-300 mb-1 font-medium">Channel Source</label>
                    <select
                      value={source}
